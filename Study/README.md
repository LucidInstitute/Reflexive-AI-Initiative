...
## Aim and Relevance
Many organizations are adopting AI. The rapid advance of AI and AI-related technologies requires organizations and society at large to reflect on their values vis-à-vis this new technology, as also happened during earlier metaparadigmatic shifts ([Hilbert, 2020](https://doi.org/10.31887/DCNS.2020.22.2/mhilbert), [Bijker, 2017](https://doi.org/10.17351/ests2017.170), [Tegegn, 2024](https://doi.org/10.1080/23311886.2024.2356916)). AI can change the nature and meaning of work ([Ateeq et al, 2025](https://doi.org/10.63332/joph.v5i4.1221), [Rostamzadeh, 2025](https://doi.org/10.1155/hbe2/8094428), [Tavantzis, Lambiase & Russo, _in press_](https://doi.org/10.6084/m9.figshare.31803529)), change the psychological contract between employers and employees ([Braganza et al, 2021](https://doi.org/10.1016/j.jbusres.2020.08.018)), reshape how work and teamwork are performed ([Tortorella, 2024](https://doi.org/10.1080/00207543.2024.2368698)) and much more ([Bankins et al, 2023](https://doi.org/10.1002/job.2735)). The aim of our initiative is to provide a practical governance framework to aid organizations in reflecting on such axiological questions.
...
Another aim of this initiative is to define what human-centered AI. An incomplete working definition is that human-centered AI is "_creating and using AI to help people perform their work in a more efficient way (faster and more accurately), while making sure that they remain in control, feel motivated, stay connected socially to their colleagues, and understand how AI affects them with autonomy to question, change, or reject its decisions._".

## General approach and Research Question
We mix participatory design science with participatory action research. In participatory design science, researchers and professionals collaborate to create artifacts to solve practical problems ([Hevner et al, 2004](https://doi.org/10.2307/25148625)). The artifact this initiative aims to develop collaboratively is a governance framework for human-centered AI. In action research, the focus lies on using iterative and incremental action as a vehicle to learn and develop knowledge ([Cornish et al, 2023](https://www.nature.com/articles/s43586-023-00214-1), [Bartels & Wittmayer, 2018](https://www.taylorfrancis.com/books/edit/10.4324/9781315148724/action-research-policy-analysis-koen-bartels-julia-wittmayer)). Action research occurs as participants use the framework-under-development to identify actions they plan to take within their own organizations to test, deepen or develop this framework, and then use those insights to inform next actions and iterate the framework. Both methodologies are iterative and cyclical, foreground collaboration between researchers and participants (as co-researchers), focus on solving problems and align on ontological and epistemological assumptions.

Our guiding Research Question is "_How can organizations leverage the power of artificial intelligence in a manner that is human-centered? What principles, rules, norms, interventions, processes and strategies are needed to achieve this? How can this be monitored?_". This question is grounded in pragmatism. While our research will develop theory, the aim of this theory is to help solve real-world challenges.
...
- Peer-review board: see [reflexiveai.org](https://reflexiveai.org).
...
- __Session 1__ ([download preliminary facilitation guide](https://raw.githubusercontent.com/LucidInstitute/Reflexive-AI-Initiative/main/Work%20Group%20Guide/Guide%20-%20Session%20%231.pdf))
  ...
  - Create a first, broad increment of the framework with actions, interventions, strategies and measures to establish or prevent the identified outcomes, and reduce the likelihood of failure.
  - Participants plan a concrete intervention they want to try within their organization before the next session, for a segment of the framework to test, develop or deepen the framework. By taking action, participants learn what else is needed.
- __Session 2__ (guide will be designed after Session 1)
  - Evaluate actions taken since the previous session, as well as input from the World Cafes, and use it to iterate the framework.
...
## Open source
The framework itself and any academic publications based on it will be published under a (Creative Commons) open source license, making it available to anyone who wishes to use or adapt it. Scientific publications will be prepared by the publication team, with additional analyses of the data as needed. The publication team consists of the coordination team and any participant or peer-review board member (see below) who wishes to contribute substantively (i.e. participate in coding, writing, analysis) to this phase of the initiative. This process is reviewed periodically by a peer-review board consisting of 8-10 members that evaluate scientific rigour and practical relevance.

## Research tradition
We position our research in the tradition of *Participatory Action Research (PAR)*. In PAR, researchers collaborate with practitioners to address a social challenge with an emphasis on empowerment, social justice and critiquing power structures ([Cornish et al., 2023](https://doi.org/10.1038/s43586-023-00214-1)). We consider this suitable for our research question because AI changes power dynamics between employers and employees, changes the meaning of work and can lead to societal challenges if used unreflexively ([Walton & Nayek, 2021](https://doi.org/10.1016/j.techfore.2021.120576); [Braganza et al, 2021](https://doi.org/10.1016/j.jbusres.2020.08.018); [Ateeq et al, 2025](https://doi.org/10.63332/joph.v5i4.1221)). Researchers are not neutral observers in PAR, which requires their reflexivity on biases, power dynamics and assumptions ([Cooper et al, 2024](https://doi.org/10.5334/cstp.684)). This is different from a traditional scientific paradigm where qualitative data is collected from participants and then analyzed objectively by detached scientists who assign meaning to the data.

## Assumptions
- We assume that all participants are active sense makers of their environments. That is, meaning is not just provided by researchers analyzing the data objectively and distantly.
- Epistemologically, we assume that the experience of practitioners is a valid source of knowledge. It may be biased (i.e. self-serving bias, optimism bias, hindsight bias), but it reflects how they make sense of their context.
- We assume critical realism ([Bhaskar, 2005](https://doi.org/10.4324/9780203090732)). Critical realism assumes there is a reality that exists independent of human awareness. It consists of generative mechanisms and forces from which social order emerges, but can only be observed indirectly. Human knowledge of this reality is limited and fallible. Critical realism sees the social sciences as a tool for social change and emancipation rather than only an interpretative instrument ([Bhaskar, 2005](https://doi.org/10.4324/9780203996249), [Bhaskar, 2009](https://doi.org/10.4324/9780203879849), [Rao, Dimitropoulos & Patten, 2025](https://doi.org/10.1177/14680173251318988)).
...
## Data analysis
- The **world cafes** provide an initial level of analysis as participants identify themes and factors collaboratively, and then prioritize them with dot voting ([Schiele et al (2022)](https://doi.org/10.1016/j.jbusres.2021.10.075) and [Lohr, Weinhardt & Sieber (2020)](https://doi.org/10.1177/1609406920916976)).
